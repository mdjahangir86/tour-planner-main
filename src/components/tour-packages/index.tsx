          ...
          <Box display="flex" justifyContent="center" gap={10} flexWrap="wrap">
            ...
            >
              ...
              <Typography variant="body1" gutterBottom>
                BANGLADESH has a thousand year old tradition Let&apos;s Explore
                the BANGLADESH!!
              </Typography>
            </Box>
            <Box sx={{ flex: { sm: 1, md: 0.5 } }}>
              <Typography variant="body1" gutterBottom>
                If you are planning to explore the BANGLADESH. Then we are here
                to keep surprising you. We are 100% local tour operator in
                Bangladesh. We always operate all tours by our own guides.
              </Typography>
              <Typography variant="body1" gutterBottom>
